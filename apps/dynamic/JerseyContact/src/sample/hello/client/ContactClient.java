...
public class ContactClient {
	...
	public static void main(String[] args) {
		...
		WebResource r = c.resource("http://localhost/JerseyContact/rest/contacts");
		
		System.out.println("===== Get huangyim =====");
		getOneContactter(r, "huangyim");
	...
	public static void getOneContactter(WebResource r, String id) {
		String jsonXml = r.path(id).accept(MediaType.APPLICATION_XML).get(String.class);
		System.out.println("derek---" + jsonXml);
	}
